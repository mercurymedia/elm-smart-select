...
import SmartSelect.ViewComponents exposing (classPrefix, viewEmptyOptionsListItem, viewOptionsList, viewOptionsListItem, viewTextField, viewTextFieldContainer)
import Task
...
update msg (SmartSelect model) =
    case msg of
        ...
        Close ->
            if model.isOpen then
                ( SmartSelect { model | isOpen = False, searchText = "", alignment = Nothing }, blurInput model.idPrefix model.internalMsg )
